...
-nIPie '<R>'")
 ...
 '(tempos-c++-open-brace-style (quote new-line))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "white" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "unknown" :family "Monospace"))))
 ...
 '(compilation-column-number ((t (:foreground "thistle"))))
 '(compilation-error ((t (:foreground "coral"))))
 '(compilation-info ((t (:foreground "light steel blue"))))
 '(compilation-line-number ((t (:foreground "sky blue"))))
 '(compilation-warning ((t (:foreground "orange"))))
 '(ediff-current-diff-A ((t (:background "#ffbbbb"))))
 ...
 '(ediff-even-diff-A ((t (:background "yellow"))))
 ...
 '(ediff-fine-diff-A ((t (:background "#ff9999"))))
 ...
 '(font-lock-jump-keyword ((t (:inherit font-lock-keyword-face :weight bold))))
