...
-nIPie '<R>'")
 ...
 '(package-selected-packages
   (quote
    (helm helm-projectile projectile company-irony flycheck-irony irony irony-eldoc flycheck flycheck-clang-analyzer flycheck-clang-tidy flycheck-clangcheck)))
...
(custom-set-faces
 ...
 '(flycheck-color-mode-line-info-face ((t (:foreground "blue"))))
