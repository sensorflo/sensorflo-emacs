(custom-set-variables
 ...
 '(grep-find-command "find ./ -maxdepth 1 -iregex '.*\\.\\(h\\|cpp\\)' -print0 | xargs -0 grep --color=always -nPe ''")
 ...
 '(icicle-incremental-completion-delay 0.2)
...
(custom-set-faces
 ...
 '(hi-semi-unimportant ((t (:foreground "gray70"))))
 '(hi-unimportant ((t (:foreground "gray90"))))
