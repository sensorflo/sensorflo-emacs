...
;;; Todo:
;; - switch between normal and rect mode 
;; - when in rect mode,
;;   - editing operates on the whole region (as IMD) [or better, look at the this variable which ctrls wheter editing deletes region or not]
;;   - some 'important' commands operating on the region (kill,yank,registerstuff) use their rect counterpart
